...
colno_attr = [6 14 17 21 22 23];   %select parameters for the procedure
...
balancing = 'Y'; %('Y' for balancing / 'N' for no balancing)
...
%% Training ML method
for i=1:7
Training_input=removevars(Training_input_all,i);
Predict_input=removevars(Predict_input_all,i);
...
% filename=['Clm.15 - ' ml_ens_dec_tree '_' Boost_Method '_' bl_method '_' Temp_scale '.xlsx'];
